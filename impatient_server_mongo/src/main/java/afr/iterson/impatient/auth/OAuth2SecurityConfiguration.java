...
public class OAuth2SecurityConfiguration {
	...
	protected static class OAuth2Config extends
		...
		private ImpatientUserDetailsService impatientUserDetailsService;
		...
		public OAuth2Config() throws Exception {
			...
			ClientDetailsService csvc = new InMemoryClientDetailsServiceBuilder()
			 ...
			 impatientUserDetailsService = new ImpatientUserDetailsService();
			...
			combinedService_ = new ClientAndUserDetailsService(csvc, impatientUserDetailsService);
		}
		...
		public UserDetailsService userDetailsService() {
			return impatientUserDetailsService;
		}
